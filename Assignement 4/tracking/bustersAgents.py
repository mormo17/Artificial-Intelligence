...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for distribution in livingGhostPositionDistributions:
            ...
            distanceToCompare = self.distancer.getDistance(pacmanPosition, argMax)

            (distance, ghostPos) = self.updateInfo(distance, distanceToCompare, argMax, ghostPos)
        ...
        for action in legal:
            ...
            distanceToCompare = self.distancer.getDistance(successor, ghostPos)

            (distance, resultAction) = self.updateInfo(distance, distanceToCompare, action, resultAction)
        
        return resultAction


    def updateInfo(self, distance, distanceToCompare, action, resultAction):
        if distanceToCompare < distance:
            distance = distanceToCompare
            resultAction = action
        
        return (distance, resultAction)